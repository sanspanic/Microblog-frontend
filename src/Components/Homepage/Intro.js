        ...
        <div className="w-full md:w-2/3 flex flex-col mt-20 sm:mt-10 md:mt-0 mb-16 items-center text-center">
          ...
          <div className="flex">
            <button
              ...
              className="bg-gray-100 inline-flex py-1 px-2 sm:py-3 sm:px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none"
            >
              <svg
              ...
              <span className="ml-4 flex items-start flex-col leading-none">
                <span className="text-xs text-gray-600 mb-1 text-right">
                  GET IT ON
                </span>
            ...
            <button
              onClick={handleAppClick}
              className="bg-gray-100 inline-flex py-1 px-2 sm:py-3 sm:px-5 rounded-lg items-center ml-4 hover:bg-gray-200 focus:outline-none"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
